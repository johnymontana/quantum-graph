...
# project
from quantumgraph.__about__ import (
    DIR_PLUGIN_ROOT,
    __icon_path__,
    __title__,
    __uri_homepage__,
...
from quantumgraph.toolbelt import PlgLogger, PlgOptionsManager
from quantumgraph.toolbelt.preferences import PlgSettingsStructure
